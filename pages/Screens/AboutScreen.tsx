...
const AboutScreen: NextPage = () => {
    ...
    return (
        <div className=' text-white py-20 px-8 flex flex-col justify-center items-center gap-12'>
            ...
            <div className='about-button relative px-9 pr-20 flex justify-center items-center gap-4 text-white border border-yellow-prime rounded-full'>
